...
import { GatewayApplicationSharedModule, UserRouteAccessService } from './shared';
...
import { GatewayApplicationAdminModule } from './admin/admin.module';
