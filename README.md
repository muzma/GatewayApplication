# GatewayApplication
Aplikasi ini diGenerate menggunakan JHipster 4.14.3, kamu dapat melihat dokumentasi dan "help" di [http://www.jhipster.tech/documentation-archive/v4.14.3](http://www.jhipster.tech/documentation-archive/v4.14.3).

Ini adalah sebuah aplikasi "gateway" intended to be part of a microservice architecture, please refer to the [Doing microservices with JHipster][] page of the documentation for more information.
